...
il = TimeSlot_Instructions ( 19 )
il.addInstruction ( Instruction ( "del", 200 ) )
il.addInstruction ( Instruction ( "del", 201 ) )
il.addInstruction ( Instruction ( "del", 202 ) )
il.addInstruction ( Instruction ( "del", 203 ) )
il.addInstruction ( Instruction ( "del", 6 ) )
il.addInstruction ( Instruction ( "del", 205 ) )
il.addInstruction ( Instruction ( "del", 206 ) )
il.addInstruction ( Instruction ( "del", 3 ) )
il.addInstruction ( Instruction ( "del", 208 ) )
tl.UpdateTree ( il )

il = TimeSlot_Instructions ( 24 )
il.addInstruction ( Instruction ( "del", 15 ) )
il.addInstruction ( Instruction ( "del", 8 ) )
il.addInstruction ( Instruction ( "del", 14 ) )
il.addInstruction ( Instruction ( "del", 18 ) )
il.addInstruction ( Instruction ( "del", 9 ) )
il.addInstruction ( Instruction ( "del", 301 ) )
